...
const MARCH8_TEMPLATES = [
  {
    ...
    customizer: null,
    card: {
      name: "Цэцэгсийн мэндчилгээ 🌷",
      desc: "Гоо үзэсгэлэнтэй, дулаахан мэндчилгээ",
      preview: "🌷✨",
      tags: ["🌸 Цэцэг", "✨ Анимэйшн"],
    },
    theme: {
    ...
    welcome: {
      ...
      title: "3-р сарын 8-ны мэнд хүргэе! 🌷",
      subtitle: "Танд зориулсан онцгой мэндчилгээ 💐",
      timer: { ...DEFAULT_TIMER },
    ...
    memoryGallery: {
      ...
      continueButton: "Үргэлжлүүлэх 🌸",
      memories: [
        { type: "image", src: "", date: "Гоо мөч", caption: "Хамтын цаг... ✨" },
        { type: "image", src: "", date: "Инээмсэглэл", caption: "Инээмсэглэл 🌸" },
      ],
    },
    stepQuestions: {
      ...DEFAULT_STEP_UI,
    ...
    finalSummary: {
      ...
      subtitle: "Танд аз жаргал, эрүүл энх хүсье!",
      ...
      quotes: [
        "Эмэгтэйчүүд бол дэлхийн хамгийн гоо генийнүүд 🌷",
        "Таны инээмсэглэл бүхнийг гэрэлтүүлдэг ✨",
  ...
  },
  {
    ...
    customizer: null,
    card: {
      name: "Ээжийн халуухан мэндчилгээ 🌺",
      desc: "Ээж, эгч, охиндоо дулаахан үгс",
      preview: "🌺💝",
      tags: ["💌 Захидал", "🌸 Хөөрхөн"],
    },
    theme: {
    ...
    welcome: {
      ...
      title: "Хайрт Ээждээ 💝",
      subtitle: "Энэ мэндчилгээ зөвхөн танд зориулагдсан 🌺",
      timer: { ...DEFAULT_TIMER },
      buttonText: "Нээх 💌",
    },
    loveLetter: {
    ...
    memoryGallery: {
      ...
      continueButton: "Үргэлжлүүлэх 🌺",
      memories: [
        { type: "image", src: "", date: "Хамтын мөч", caption: "Ээжтэйгээ хамт... 💝" },
        { type: "image", src: "", date: "Инээмсэглэл", caption: "Инээмсэглэл бүхэн 🌺" },
      ],
    },
    stepQuestions: null,
    finalSummary: {
      ...
      quotes: [
        ...
        "Ээжийн хайр бол хамгийн гоо зүйл 🌺",
        "Ээж минь, та бол миний баатар 🌸",
      ],
      footer: "3-р сарын 8 © 2026 • mendchilgee.site",
    },
    effects: {
  ...
  },
  {
    ...
    customizer: null,
    card: {
      name: "Орчин үеийн мэндчилгээ 💐",
      desc: "Залуу, энержитэй, гоёмсог стиль",
      preview: "💐🎀",
      tags: ["🎀 Орчин үе", "✨ Sparkle"],
    },
    theme: {
    ...
    welcome: {
      ...
      subtitle: "Та бол онцгой! Энэ мэндчилгээ танд 🎀",
      timer: { ...DEFAULT_TIMER },
      buttonText: "Нээх ✨",
    },
    loveLetter: {
    ...
    memoryGallery: {
      ...DEFAULT_GALLERY_UI,
      memories: [
        { type: "image", src: "", date: "✨", caption: "Гайхалтай мөч" },
      ],
    },
    stepQuestions: null,
    finalSummary: {
