...
const LONG_DISTANCE_TEMPLATES = [
  // ─── Theme 1: Sunset Galaxy ───
  {
    ...
    question: {
      ...
      text: "Чи миний Valentine болох уу? 🌅🥺",
      yesButton: { ...DEFAULT_YES_BUTTON },
      noButton: { ...DEFAULT_NO_BUTTON },
    },
    memoryGallery: {
    ...
    finalSummary: {
      ...
      title: "Баярлалаа 🎉",
      subtitle:
        "Одоо хэдий хол байгаа ч гэсэн дараа жилийн Valentine-ийг хамт тэмдэглэе.\n Ирээдүйд олон олон гоё дурсамжийг бүтээнээ.\n Үнэхээр их хайртай шүү💕",
      summaryFields: [
        { key: "place", emoji: "📍", label: "Уулзах газар" },
        { key: "activity", emoji: "🎯", label: "Хийх зүйл" },
        { key: "time", emoji: "⏰", label: "Цаг" },
